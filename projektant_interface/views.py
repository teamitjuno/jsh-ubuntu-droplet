...
from projektant_interface.pdf_generators.pdf_template_processor_v3 import generate_pdf_bauplan, CustomPDF
...
def create_project_bauplan_pdf(request, project_id):
    ...
    kunden_strasse, kunden_plz_ort = extract_address_parts(str(project.Kunde_Adresse_PVA) if project.Kunde_Adresse_PVA else "Straße 0, Stadt, 00000")
...
def serve_pdf(request, project_id):
    ...
    response = FileResponse(
        project.bauplan_pdf, content_type="application/pdf"
    )
