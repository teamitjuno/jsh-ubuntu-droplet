...
app.conf.beat_schedule = {
    ...
    'delete_vertriebangebot_six_weeks_old': {
        ...
        'schedule': crontab(day_of_week=0, hour=1, minute=0),  # Wöchentlich, Sonntags um 01:00 Uhr
    },
    'delete_angenommen_vertriebangebot_two_months_old': {
        ...
        'schedule': crontab(day_of_month=1, hour=2, minute=0),  # Monatlich am ersten Tag des Monats um 02:00 Uhr
    },
}