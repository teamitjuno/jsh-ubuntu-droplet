...
class Datenblatter(models.Model):
    ...
    speicher_module_viessmann = models.FileField(upload_to="uploads/", blank=True, null=True)
    ...
    wechselrichter_viessman = models.FileField(upload_to="uploads/", blank=True, null=True)
